...
public class LaneView implements LaneObserver, ActionListener {
	...
	private LaneViewProduct laneViewProduct = new LaneViewProduct();
	private int roll;
	...
	public LaneView(Lane lane, int laneNum) {
		...
		initDone = true;
		laneViewProduct.setFrame(new JFrame("Lane " + laneNum + ":"));
		cpanel = laneViewProduct.getFrame().getContentPane();
		cpanel.setLayout(new BorderLayout());

		laneViewProduct.getFrame().addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				laneViewProduct.getFrame().hide();
			}
		});
	...
	public void show() {
		laneViewProduct.show();
	}

	public void hide() {
		laneViewProduct.hide();
	}
