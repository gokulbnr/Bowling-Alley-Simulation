...
public class EndGameReport implements ActionListener, ListSelectionListener {
	...
	private EndGameReportProduct endGameReportProduct = new EndGameReportProduct();
	private JFrame win;
	...
	public EndGameReport( String partyName, Party party ) {
		...
		endGameReportProduct.setResult(0);
		endGameReportProduct.setRetVal(new Vector());
		...
		// Member Panel
		JPanel partyPanel = createMemberPanel(party);

		// Button Panel
		// Button Panel
		JPanel buttonPanel = createButtonPanel(party);
	...
	private JPanel createButtonPanel(Party party) {
	...
	private JPanel createMemberPanel(Party party) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(printButton)) {
			...
			endGameReportProduct.getRetVal().add(selectedMember);
		}
		if (e.getSource().equals(finished)) {
			win.hide();
			endGameReportProduct.setResult(1);
		}
	...
	public Vector getResult() {
		return endGameReportProduct.getResult();
	}
	...
	public static void main( String args[] ) {
		...
		EndGameReport e = getBowlerEndGameReport(bowlers);
	}

	private static EndGameReport getBowlerEndGameReport(Vector bowlers) {
